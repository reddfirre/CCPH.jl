...
mutable struct TreePar{T<:Float64}
    ...
    a_Jmax::T #Slope of the Nitrogen per leaf area (Nₐ)-Jmax line (mol m⁻² leaf s⁻¹ Nₐ⁻¹)
    b_Jmax::T #Intercept of the Nitrogen per leaf area (Nₐ)-Jmax line (mol m⁻² leaf s⁻¹)
...
Nₛ::T=0.04,rₘ::T=24.0,k::T=0.52,m::T=0.05,a_Jmax::T=0.033,b_Jmax::T=1.21e-5,LMA::T=0.256
,Kr::T = 0.35,rW::T = 0.07,rR::T = 0.6,r_gₛ::T = 0.42) where {T<:Float64}  = 
TreePar(αf,ρw,β₁,β₂,Tf,Tr,y,z,Nₛ,rₘ,k,m,a_Jmax,b_Jmax,LMA,Kr,rW,rR,r_gₛ)
